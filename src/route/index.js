...
var header = {
  ...
  salary: '600$ в місяць',
  address: 'Kharkiv region. Harkov city. Prospect Nauki 50',
}
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      certificates: [
        {
          name: 'certificat Harvard',
          id: 10251,
        },
        {
          name: 'certificat Stanford',
          id: 12255,
        },
        {
          name: 'certificat Oxford',
          id: 102525,
        },
      ],
          ...
          projects: [
            {
              ...
              awards: [
                {
                  name: 'Dicta adipisci rerum harum nulla numquam odit quo quibusdam dolores',
                },
                {
                  name: 'Unde eius animi placeat eligendi ut autem!',
                },
              ],
              awardAmount: 20,
            },
